...
aboutbg = loadImage("images/images.png")
 ...
 // strokeWeight(3);
  ...
  else if(MENU == 3)
  {
    createCanvas(windowWidth, windowHeight);
      ...
      text("● Click on the logout button after you login to exit your current account.", 20,160 );
      text("● Search for sellers, and click on one after you decide to send a message to him/her... ",20, 190);
      text("●  [Only for sellers] You can rate an user, or even cancel the Registration.", 20, 220);
      text("● [only for moderators] You can send warning to a seller or an user account.", 20, 250);
      text(" After 15 such warnings, the account gets blocked.", 20, 280)
